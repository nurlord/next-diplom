        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-4 space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`w-11 h-6 rounded-full transition-colors relative ${isPremiumOnly ? "bg-orange-500" : "bg-neutral-700"}`}
            >
              <span className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${isPremiumOnly ? "translate-x-5" : "translate-x-0.5"}`} />
            </button>
          </div>
